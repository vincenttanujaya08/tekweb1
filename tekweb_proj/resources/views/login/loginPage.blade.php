...
<head>
    ...
    <!-- Untuk Sintaks CSS/JS -->
    
    <link href="{{ asset('css/login.css') }}" rel="stylesheet">
    <link href="{{ asset('css/app.css') }}" rel="stylesheet">

    
    <!-- Nanti Sertain selalu yaa iniiiii buat bootstrrap -->
...
<!-- Wrapper box di dalam body yg membungkus kiri n knan -->
    <div class="box-wrapper">
        <div class="container wrapper">
            <div class="row">
                <div class="col left">
                    <!-- sintaks buat gambar ges -->
                ...
                <div class="col right">
                    ...
                    <!-- ini buat refrensikan ke halaman laen -->
